...
final class ProdOsMaintenance1183WorkflowTest extends TestCase {
  ...
  public function testOneShotApplyClaimIsAtomicAndAuthorityScoped(): void {
    ...
    foreach ([
      'NO_EOL_COMMAND=PASS',
      'TERMINAL_LF_COMMAND=PASS',
      'TERMINAL_CRLF_COMMAND=PASS',
      'LF_AUTHORITY_LOOKUP_NORMALIZED=PASS',
      'CRLF_AUTHORITY_LOOKUP_NORMALIZED=PASS',
      'LEADING_SPACE=REJECTED',
      'LEADING_TAB=REJECTED',
      'TRAILING_SPACE=REJECTED',
      'TRAILING_TAB=REJECTED',
      'EMBEDDED_NEWLINE=REJECTED',
      'EMBEDDED_CR=REJECTED',
      'DOUBLE_TERMINAL_LF=REJECTED',
      'DOUBLE_TERMINAL_CRLF=REJECTED',
      'EXTRA_TOKEN=REJECTED',
      'MALFORMED_TUPLE=REJECTED',
